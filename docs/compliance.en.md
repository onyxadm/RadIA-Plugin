...
This document establishes the compliance guidelines, terms of use, and data privacy policies for the **RadIA** plugin.
...
RadIA operates under a "Bring Your Own Key" (BYOK) policy:
