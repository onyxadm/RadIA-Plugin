...
- **Custom System Instructions:** System instruction persisted in `HKEY_CURRENT_USER\Software\RadIA\SystemPrompt`. Automatically injected as the first `mrSystem` message in every interaction.
